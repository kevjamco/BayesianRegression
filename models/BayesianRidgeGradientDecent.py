...
Bayesian Gradeinet Decent (Bayes by Backprop)
Addapted from ridge regression code from: Adapted from: https://github.com/vikasrtr/pyRidge

"""

import numpy as np
from models.math_tools import normal_pdf, pdf_dx, pdf_dmu, pdf_dsig, ln_pdf_dx, ln_pdf_dmu, ln_pdf_dsig
